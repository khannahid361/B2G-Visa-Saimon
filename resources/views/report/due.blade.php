...
<div class="d-flex flex-column-fluid">
    <div class="container-fluid">
        ...
        <form action="{{route('due.report')}}" method="GET">
            @csrf
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="table-responsive">
                                                <table id="testTable"
                                                    class="table table-bordered table-hover table-display">
                                                    <thead class="bg-primary text-white">
                                                        <tr>
                                                            ...
                                                            <td class="text-center">Visa Fee</td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @php
                                                        $passport =
                                                        \Modules\WalkIn\Entities\Passport::where('walkin_app_info_id',$row->id)->get();
                                                        @endphp
                                                        <tr>
                                                            ...
                                                            <td class="text-right">{{ $row->checklist->price -
                                                                ...
                                                                @php
                                                                $total_due += $row->checklist->price - $row->paid_amount
                                                                -
                                                                $row->discount;
                                                                @endphp
                                                            </td>
