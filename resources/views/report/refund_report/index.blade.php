...
<div class="d-flex flex-column-fluid">
    <div class="container-fluid">
        ...
        <form id="refund_filter_form" method="post">
            @csrf
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    <div class="col-md-12">
                        ...
                        <div id="invoice" class="col-md-12 labor-bill">
                            ...
                            <div class="card-body">
                                ...
                                <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="table-responsive" id="refund_report_data">
...
<script>
    $(document).ready(function () {
        ...
        $('#refund_filter_form').on('submit', function(e) {
            e.preventDefault();

            $.ajax({
                url: "{{ route('refund.report.data') }}",
                type: "POST",
                data: $(this).serialize(),
                ...
                success: function(response) {
                    ...
                    $.each(response.report, function(index, row) {

                        let refund = row.payment_refund;

                        totalRefund += parseFloat(refund.amount);
                        ...
                        html += `
                            <tr>
                                ...
                                <td>${row.phone ?? ''}</td>
                                <td>${refund.reason ?? ''}</td>
                                <td>${refund.account_type == 4 ? 'Cash' : 'Bank/Mobile Bank'}</td>
                                <td class="text-right">
                                    ${parseFloat(refund.amount).toFixed(2)} TK
                                </td>
                            </tr>
                        `;
                    });
