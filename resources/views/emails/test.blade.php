                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                                        <p style="font-family: sans-serif; font-size: 16px; font-weight: bold; margin: 0; margin-bottom: 15px;">Thank You <span style="color: green">{{$datas->p_name}}</span> !</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Your Visa Application Payment <span style="color: green">{{$payment}}</span> is received. </p>
                                            ...
                                            <tr>
                                                <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;" valign="top">
                                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
                                                        ...
                                                        <tr>
                                                            <td style="font-weight: bold">Application Status: <span style="font-weight: normal">{{WALKIN_APP_STATUS_VALUE[$datas->status]}}</span></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            @if($payment_status == 2)
                                                            <td style="font-weight: bold">Payment History: <span style="font-weight: normal">{{$datas->paid_amount + $datas->due_amount}}</span></td>
                                                            @else
                                                            <td style="font-weight: bold">Payment History: <span style="font-weight: normal">{{$datas->paid_amount + $payment}}</span></td>
                                                            @endif
                                                        </tr>
                                                        <tr>
                                                            <td style="font-weight: bold">Payment Status: <span style="font-weight: normal">{{WALKIN_APP_PAYMENT_STATUS[$payment_status]}}</span></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
