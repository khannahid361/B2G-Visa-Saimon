        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{ route('role') }}" class="btn btn-primary btn-sm font-weight-bolder">
                    ...
                    <div class="col-sm-12">
                        <form id="saveDataForm" method="post">
                            ...
                            <div class="row">
                                ...
                                <x-form.selectbox labelName="Department Name" name="department_id" required="required" col="col-md-6" class="selectpicker">
                                    @foreach ($department as $row)
                                        @if(isset($role))
                                            <option value="{{ $row->id }}"{{$row->id == $role->department_id ? 'selected' : ''}}>{{ $row->department_name }}</option>
                                        ...
                                        @if (!empty($permission_modules))
                                            @foreach ($permission_modules as $menu)
                                                ...
                                                <li>
                                                    <input type="checkbox" name="module[]" class="module" value="{{ $menu->id }}"
                                                    @isset($role_module)
                                                        @if(collect($role_module)->contains($menu->id)) {{ 'checked' }}
                                                            @endif
                                                    @endisset
                                                    >
                                                    {!! $menu->type == 1 ? $menu->divider_title.' <small>(Divider)</small>' : $menu->module_name !!}
