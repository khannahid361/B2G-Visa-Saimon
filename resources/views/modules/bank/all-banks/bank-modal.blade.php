        ...
        <div class="modal-content">
            ...
            <form id="store_or_update_form" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        <x-form.selectbox labelName="Bank type" name="bank_type" required="required" col="col-md-12" class="selectpicker" onchange="getEmployee(this.value)">
                            <option value="4">Cash</option>
                            <option value="1">Bank</option>
                            <option value="2">Mobile Bank</option>
                        </x-form.selectbox>
                        <input type="hidden" name="update_id" id="update_id"/>
                        <x-form.textbox labelName="Bank Name" name="bank_name" required="required" col="col-md-12" placeholder="Enter Bank name"/>
