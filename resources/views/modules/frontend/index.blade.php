            ...
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);"
                        onclick="showFormModal('{{__('Add New About Us')}}','{{__('Save')}}')"
    ...
    let table;
        $(document).ready(function(){
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{route('aboutus.datatable.data')}}",
                    "type": "POST",
                    "data": function (data) {
                        data._token          = _token;
                    }
            ...
            $(document).on('click', '#save-btn', function () {
                ...
                let url      = "{{ route('aboutus.store.or.update') }}";
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.status === 'error') {
                                ...
                                if (window.detailsEditor) {
                                    detailsEditor.setData(data.description);
                                }
                                ...
                                $('#store_or_update_modal .modal-title').html(
                                    '<i class="fas fa-edit text-warning"></i> <span>{{ __("Edit About Us") }} </span>'
                                );
