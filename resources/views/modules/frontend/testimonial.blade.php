            ...
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);"
                        onclick="showFormModal('{{__('Add New Terms & Condition')}}','{{__('Save')}}')"
...
@include('frontend::modal.testimonialmodal')
@endsection
@push('scripts')
    ...
    let table;
        $(document).ready(function(){
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{route('testimonials.datatable.data')}}",
                    "type": "POST",
                    "data": function (data) {
            ...
            $(document).on('click', '#save-btn', function () {
                ...
                let url      = "{{ route('testimonials.store.or.update') }}";
                        ...
                        success: function (data) {
                            if (data.status === 'error') {
                                ...
                                $('#store_or_update_modal .modal-title').html(
                                    '<i class="fas fa-edit text-warning"></i> <span>{{ __("Edit Testimonial") }} </span>'
                                );
            ...
            $(document).on('click', '.delete-data', function () {
                ...
                let url   = "{{ route('testimonials.delete') }}";
