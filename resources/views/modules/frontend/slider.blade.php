        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showFormModal('{{__('Add New Slider')}}','{{__('Save')}}')"
...
@include('frontend::modal.slidermodal')
@endsection
@push('scripts')
    ...
    let table;
        $(document).ready(function(){
            ...
            $(document).on('click', '#save-btn', function () {
                ...
                let url      = "{{ route('slider.store.or.update') }}";
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.status === 'error') {
                                ...
                                $('#store_or_update_form #message').val(data.message);
                                ...
                                $('#store_or_update_modal .modal-title').html(
                                    '<i class="fas fa-edit text-warning"></i> <span>{{ __("Edit Slider") }} </span>'
                                );
