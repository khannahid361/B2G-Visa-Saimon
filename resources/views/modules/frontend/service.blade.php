        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showFormModal('{{__('Add New Service')}}','{{__('Save')}}')"
...
@include('frontend::modal.servicemodal')
@endsection
@push('scripts')
    ...
    let table;
        $(document).ready(function(){
            ...
            $(document).on('click', '#save-btn', function () {
                ...
                let url      = "{{ route('service.store.or.update') }}";
                        ...
                        success: function (data) {
                            if (data.status === 'error') {
                                ...
                                $('#store_or_update_modal .modal-title').html(
                                    '<i class="fas fa-edit text-warning"></i> <span>{{ __("Edit Service") }} </span>'
                                );
