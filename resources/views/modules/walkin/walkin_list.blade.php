            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        <div class="row">
                            <x-form.selectbox labelName="{{__('Destination')}}" name="visaType_id" id="visaType_id" col="col-md-3" class="">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{route('walkIn.datatable.walkIn.data')}}",
                    "type": "POST",
                    "data": function (data) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.status == 'error') {
                                ...
                                $('#approve_status_form #name').val(data.name);
            ...
            $(document).on('click', '#status-btn', function () {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: {status_id: status_id, visa_status: visa_status, note: note,phone:phone, _token: _token},
                    dataType: "JSON",
                    beforeSend: function () {
