        ...
        <div class="modal-content">
            ...
            <form id="refund_form" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class=" col-md-12">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="">{{__('Application Number')}}</label>
                                    <input type="text" class="form-control bg-primary text-white" name="" id="application_number" value=""
                                        readonly>
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control bg-primary text-white" name="" id="refundable_amount" value=""
                                        readonly>
                                </div>
                                <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control selectpicker refund-account-type" id="account_type"
                                name="account_type" required="required" data-account="bank_account_id"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" id="refundButton">{{ __('Refund') }}</button>
                </div>
            </form>
            <!-- /modal body -->
        </div>
