...
class SslCommerzPaymentController extends Controller
{
    ...
    public function exampleHostedCheckout($id)
    {
        ...
        //  $purchases1  = \Illuminate\Support\Facades\DB::table('walkin_app_details')
        //             ->join('checklists', 'checklists.id', '=', 'walkin_app_details.c_visa_category')
        //             ->where('walkin_app_details.walkin_app_info_id', $data->id)
        //             ->sum('checklists.service_charge');
        ...
        if ($order_detials->status == 'Pending') {
            ...
            if ($validation) {
                ...
                */
                ...
                echo "<br >Transaction is successfully Completedeeeeeeeeeee";
            }
        } else if ($order_detials->status == 'Processing' || $order_detials->status == 'Complete') {
            /*
             That means through IPN Order status already updated. Now you can just show the customer that transaction is completed. No need to udate database.
             */
            echo "Transaction is successfully Completed wwwwwwwwwwww";
        } else {
