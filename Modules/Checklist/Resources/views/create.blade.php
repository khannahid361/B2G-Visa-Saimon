                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group required">
                                                ...
                                                <div class="input-group" >
                                                    <input type="text" class="form-control" required="required" name="price" id="price" placeholder="Visa Price">
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label for="title">{{__('Service charge')}}</label>
                                                <div class="input-group" >
                                                    <input type="text" class="form-control"  name="service_charge" id="price" placeholder="service charge">
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="">
                                                        <table class="table table-bordered quarterSelectTable" id="saleTable">
                                                            ...
                                                            <tr class="text-center">
                                                                <td><input type="text" class="form-control" required="required" name="checklist_name[]"/></td>
                                                                <td><button type="button" class="btn btn-primary btn-sm addRaw"><i class="fas fa-plus-circle"></i></button></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
