                                                            ...
                                                            <td>
                                                                <div class="row">
                                                                    <div class="col-md-3 form-group required">
                                                                        <p >Name : {{$visa_info->p_name}}</p>
                                                                    </div>
                                                                    <div class="col-md-3 form-group required">
                                                                        <p >Passport Number : {{$visa_info->passport_number}}</p>
                                                                    </div>
                                                                    <div class="col-md-3 form-group required">
                                                                        <p >Phone Number : {{$visa_info->phone}}</p>
                                                                    </div>
                                                                    <div class="col-md-3 form-group required">
                                                                        <p >Email : {{$visa_info->email}}</p>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12 form-group">
                                                                        <fieldset>
                                                                            ...
                                                                            <div class="form-group " id="checklist_1">
                                                                                ...
                                                                                <div class="line">
                                                                                    @if(!empty($check_list))
                                                                                        <input name="file" type="text" value="{{$check_list->file}}">
...
{{--                                                                                    $check_lists = \Modules\WalkIn\Entities\WalkinAppChecklist::where('walkin_app_info_id',$visa_info->id)->get();--}}
{{--                                                                                @endphp--}}
{{--                                                                                @foreach($visa_checklist as $key=>$ckl)--}}
{{--                                                                                    @php--}}
{{--                                                                                        $check_list = $check_lists->where('check_list_id',$ckl->id)->first();--}}
{{--                                                                                    @endphp--}}
{{--                                                                                    <div class="line">--}}
...
{{--                                                                                        @if(!empty($check_list))--}}
{{--                                                                                            <input name="check[{{$key+1}}][][file]" type="text" value="{{$check_list->file}}">--}}
{{--                                                                                            <input type="checkbox" class="my-checkbox" name="check[{{$key+1}}][][check_list_id]" value="{{$ckl->id}}"--}}
{{--                                                                                                {{  ($ckl->id == $check_list->check_list_id  ? 'checked' : '') }}/>--}}
{{--                                                                                            {{$ckl->checklist_name}}--}}
{{--                                                                                        @else--}}
{{--                                                                                            <input name="check[{{$key+1}}][]'file'" type="text" value="">--}}
{{--                                                                                            <input type="checkbox" class="my-checkbox" name="check[{{$key+1}}][]'check_list_id'" value="{{$ckl->id}}"--}}
{{--                                                                                            />{{$ckl->checklist_name}}--}}
{{--                                                                                        @endif--}}
{{--                                                                                    </div>--}}
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="form-group col-md-6 required">
                                                                            ...
                                                                            <select class="form-control selectpicker receiver_id VisaCatChecklistChild" id="receiver_{{ $key+1 }}" name="visa[{{ $key+1 }}][c_visa_category]" required="required" data-receiver = receiver_{{ $key+1 }} data-checklistchild = "checklistchild_{{ $key+1 }}" data-live-search="true">
                                                                                <option value="{{ $v_app_d->checklistCat->id }}" >{{ $v_app_d->checklistCat->title }}</option>
                                                                            </select>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-12 form-group">
                                                                            <fieldset>
                                                                                ...
                                                                                <div class="form-group input_field" id="checklistchild_{{ $key+1 }}">
                                                                                    ...
                                                                                    @endphp
                                                                                    @foreach($v_app_d->checklistCat->checklistDetailes as $keys=>$ckl_d)
                                                                                        ...
                                                                                        <div class="line">
                                                                                            ...
                                                                                            <input type="checkbox" class="my-checkbox" name="visa[{{$key+1}}][c_check_list_id][]" value="{{$ckl_d->id}}"{{  ($ckl_d->id == $check_d_list->c_check_list_id  ? ' checked' : '') }}/>
                                                                                            {{$ckl_d->checklist_name}}
                                                                                            @else
                                                                                                <input type="checkbox" class="my-checkbox" name="visa[{{$key+1}}][c_check_list_id][]" value="{{$ckl_d->id}}"/>
                                                                                                {{$ckl_d->checklist_name}}
                                                                                            @endif
                                                                                        </div>
                                                                                    @endforeach
...
`;
    ...
    <script>
        $(document).on('click','.save_btn',function(){
            ...
            let url      = "{{route('onlineApp.update')}}";
