...
{
    protected $fillable = ['account_id', 'bank_name','balance', 'employee_id', 'account_name', 'account_number', 'status', 'created_by', 'modified_by'];
    ...
    *******************************************/
    ...
    private function get_datatable_query(){
        ...
        $query = self::with('user')->where('status', 1);
