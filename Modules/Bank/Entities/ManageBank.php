...
class ManageBank extends BaseModel{
    protected $fillable = [ 'bank_name','account_name', 'account_number', 'bank_type', 'status'];

    public function banks()
    {
        return $this->hasMany(Bank::class, 'account_id'); // Adjust the foreign key according to your schema
    }
