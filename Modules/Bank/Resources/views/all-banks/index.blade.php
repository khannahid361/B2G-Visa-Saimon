...
@include('bank::all-banks.bank-modal')
@endsection
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('bank.manage.bank.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
                    data.bank_type      = $("#form-filter #bank_type").val();
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{route('bank.manage.store.or.update')}}";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status == 'error'){
                            ...
                            $('#store_or_update_form #bank_type').val(data.bank_type);
