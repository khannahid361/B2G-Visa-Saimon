                    ...
                    <div class="card-toolbar no_print">
                        ...
                        <div class="card-toolbar">
                            @if (permission('customer-group-add'))
                                <a href="javascript:void(0);" onclick="showFormModal('{{__('Add New Customer Group')}}','{{__('Save')}}')" class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i> {{__('Add New')}}</a>
                            @endif
                        </div>
                        <!--end::Button-->
                    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{route('customer.group.store')}}";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(data.status == 'error'){
                            ...
                            $('#store_or_update_form #name,#store_or_update_form #name').val(data.name);
