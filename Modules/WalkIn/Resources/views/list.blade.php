                ...
                <div class="card-header flex-wrap py-5">
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        <div class="row">
                            ...
                            <x-form.textbox labelName="Barcode" name="barcode" col="col-md-4"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#payment-status-btn', function () {
                ...
                var account_type        = $('#approve_payment_status_form #account_type option:selected').val();
                var account_id          = $('#approve_payment_status_form #account_id').val();
                    ...
                    success: function (data) {
                        ...
                        if (data.status == 'success') {
                            ...
                            $.each(data.errors, function (key, value) {
                                $('#approve_payment_status_form input#' + key).addClass('is-invalid');
                                $('#approve_payment_status_form textarea#' + key).addClass('is-invalid');
                                $('#approve_payment_status_form select#' + key).parent().addClass('is-invalid');
                                $('#approve_payment_status_form #' + key).parent().append(
