<div class="modal fade" id="partial_payment_status_modal" tabindex="-1" role="dialog" aria-labelledby="model-1"
    aria-hidden="true">
                        ...
                        <div class=" col-md-12">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 available-discount" style="display: none">
                                    ...
                                    <input type="text" readonly class="form-control" name="" id="available_discount" value="">
                                </div>
                                <div class="form-group col-md-4 discount" style="display: none">
                                    <label for="discount">{{__('Discount (Optional)')}}</label>
                                    <input type="text" class="form-control" data-available_discount="available_discount" name="discount" id="discount" value="">
                                </div>
                                ...
                                <div class="form-group col-md-4 payment">
                                    <label for="paid_amount">{{__('Receive Amount')}}</label>
                                ...
                                <div class="form-group col-md-4 payment">
                                    ...
                                    <input type="text" class="form-control due_amount" name="due_amount" id="due_amount"
                                        value="0.00" readonly>
                                </div>
                                <div class="form-group col-md-12 payment">
                                    <textarea cols="60" rows="5" name="payment_note" id="payment_note"
                                        style=""></textarea>
                                </div>
                            </div>
                        </div>
