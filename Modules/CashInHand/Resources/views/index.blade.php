        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showFormModal('Add New Cash','Save')" class="btn btn-primary btn-sm font-weight-bolder">
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('cashInHand.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
        ...
        $(document).on('click', '#save-btn', function (){
            ...
            let url = "{{route('cashInHand.store.or.update')}}";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status == 'error'){
                            ...
                            $('#store_or_update_form #bank_name').val(data.id);
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let url    = "{{ route('cashInHand.change.status') }}";
